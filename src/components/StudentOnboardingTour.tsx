...
const STEPS: TourStep[] = [
  {
    ...
    body: "Здесь — инструкторы, расписание, чат, билеты ПДД и история. Используйте достоверные данные, не передавайте вход третьим лицам; запись и талоны — по правилам школы и подсказкам в приложении. Полный текст — документ «Правила пользования для курсанта» (docs/ПРАВИЛА_КУРСАНТ.md или у администратора). Далее — кратко по разделам меню. «Пропустить» — в любой момент.",
    navTarget: null,
  },
  {
    key: "home",
    title: "Главная",
    body: "Профиль, статус аккаунта, талоны и закреплённые инструкторы. Недельное расписание: подтверждённые занятия, бронь свободных окон, отмена в допустимых случаях. Во время занятия — подтверждение старта вождения и таймер по подсказкам на экране.",
    navTarget: "home",
  },
  {
    key: "chat",
    title: "Чат",
    body: "Переписка с инструкторами и администратором. Соблюдайте вежливость; не передавайте переписку третьим лицам без необходимости. На значке может быть число непрочитанных сообщений.",
    navTarget: "chat",
  },
  {
    key: "tickets",
