 ...
 * Учитываются слоты в работе (ожидание подтверждения, запланировано); отменённые и завершённые
 * не резервируют время — после вождения можно записать на следующий интервал в тот же день.
